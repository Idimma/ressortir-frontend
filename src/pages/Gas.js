                                    ...
                                    <form onSubmit={handleSubmit} className="request-quote-form">
                                        ...
                                        <div style={{display: showProfile ? 'block' : 'none'}}>
                                            ...
                                            <div className="row">
                                                <div
                                                    className="col-sm-12">
                                                    <h5 className="form__title">Payment
                                                        Option </h5>
                                                </div>
                                            </div>
                                            <div
                                                className="row mb-10 radio-wrapper">
                                                <div
                                                    className="message col-12"></div>
                                                <div
                                                        ...
                                                        <label
                                                            ...
                                                            <div
                                                                className="label-check_text-meta">
                                                                                                                <span
                                                                                                                    className="label-check_text-descr">Pay Online (paystack)</span>
                                                    ...
                                                    <div
                                                        ...
                                                        <label
                                                            ...
                                                            <div
                                                                className="label-check_text-meta">
                                                                                                                <span
                                                                                                                    className="label-check_text-descr">Pay using POS Machine on delivery </span>
                                                    ...
                                                    <div
                                                        ...
                                                        <label
                                                            ...
                                                            <div
                                                                className="label-check_text-meta">
                                                                                                                <span
                                                                                                                    className="label-check_text-descr">Pay cash on delivery </span>
