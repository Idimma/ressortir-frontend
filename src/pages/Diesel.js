                                ...
                                >
                                    ...
                                    <div className="row mb-10">
                                        <div className="col-sm-12 col-md-12 col-lg-12">
                                            ...
                                            <p className=" d-block mb-10">* Kindly note that the Minimum Quantity of Diesel that can be requested is <strong>2500Litres</strong></p>

                                        </div>
                                        <div className="col-sm-12 col-md-12 col-lg-12">
                                            <div className="form-group">
                                                <input type="text" className="form-control " name="quantity" placeholder="Diesel Quantity (min: 2000 litres)" />
                                            </div>
                                        </div>
                                        <div className="col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <div className="row mb-10">
                                        ...
                                        <div className="col-sm-12 col-md-12 col-lg-12">
                                            <div className="form-group">
                                                <input type="text" className="form-control " name="delivery_address" placeholder="Full Delivery Address" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="row">
                                        <div className="col-sm-12 col-md-12 col-lg-12 text-center">
                                            <button type="submit" className="btn btn-danger btn-round btn-md">Request A Quote</button>
                                        </div>
                                    </div>
                                        </form>)}</Formik>
                            </div>
