      ...
      <div className="sticky-bottom d-sm-none bg-white mobile-footer">
        <div className="d-flex text-gray justify-content-between container py-3">
          ...
          {Auth.isAuthenticated() && (
            <NavLink
              to="#"
              exact
              className="text-center text-black-50 toggler-nav"
            >
        ...
        >
          <img
            width={30}
            height={30}
            src="/images/favicon/favicon-r.png"
            alt="Ressortir App"
          />
          ...
          <button
            id="notificationBtn"
            className="btn btn-success mr-3 btn-sm fs-12"
          >
            Install
          </button>
        ...
        >
          ...
          <button
            id="androidInstallerBtn"
            className="btn btn-success btn-sm fs-12 mr-3"
          >
            Install
          </button>
          <AiOutlineClose
            id="androidInstallerClose"
        ...
        {showInstallMessage && (
          <div
            className="d-flex px-4 py-1 m-2 aligned bg-info text-white"
            style={{ borderRadius: 8 }}
          >
            <img
              width={30}
            ...
            />
            <p className="my-0 mx-3 fs-12" style={{ color: "#fff" }}>
              Install Ressortir App on your iPhone: tap{" "}
              <IoIosShare className="fs-16" /> and then Add to homescreen
            </p>
            <AiOutlineClose
        ...
        {!online && (
          <div
            className="d-flex px-4 py-1 mb-2 mx-2 aligned bg-danger text-center text-white"
            style={{ borderRadius: 8 }}
          >
...
const MobileFooter = connect(
  ({ User: user, Auth: auth, Application: application }) => ({ ...auth }),
  null
)(_MobileFooter);
          ...
          <nav className="navbar navbar-expand-lg">
            <div className="container">
              <NavLink
                ...
                to="/"
                title="Ressortir Home Page"
              >
                <img
                  src="/images/logo/ressortir-logo.png"
          ...
          <div className="container">
            ...
            {!Auth.isAuthenticated() ? (
              <div className="nav-form">
                <NavLink
                  to="/login"
                  className="nav-form-btn btn-login-mobile"
                  title="Login"
                >
                  Login
                </NavLink>
              ...
              <div className="nav-form dash-head-link">
                <div className="dash-link">
                  <div className="dash-message mr-3">
...
const WebHeader = connect(({ User }) => ({ user: User }), { logout })(
  withRouter(_WebHeader)
);
          ...
          <div className="row">
            <div className="col-sm-12 col-md-4 col-lg-4">
              <div className="contact-panel">
                ...
                <ul className="contact__list list-unstyled">
                  <li>
                    10A Kafayat Abdulrasaq Street off Fola Osibo Lekki Phase 1,
                    Lagos State.
                  </li>
            ...
            <div className="col-sm-12 col-md-4 col-lg-4">
              <div className="contact-panel">
                ...
                <div className="contact__panel-header mt-4">
                  <h4 className="contact__panel-title">Branch Office 2:</h4>
                </div>
                <ul className="contact__list list-unstyled">
                  <li>
                    16A Ben Akabueze Street, Majek Sangotedo, Lagos State.
                  </li>
                  <li>Phone number: 09013844444</li>
                </ul>
              </div>
            </div>
            <div className="col-sm-12 col-md-4 col-lg-4">
              <div className="contact-panel social-panel">
                <div className="social__icons justify-content-center">
                  ...
                  <a
                    href="https://api.whatsapp.com/send?phone=2348063096005"
                  ...
                  <a
                    href="https://twitter.com/RessortirGlobal"
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <a
                    href="https://www.instagram.com/ressortirglobal/"
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="footer__copyright">
                  <span>Copyright © {new Date().getFullYear()} Ressortir</span>
                </div>
              </div>
            </div>
          </div>
                            ...
                            <ul className="navbar-nav">
                              <li className="nav__item">
                                <NavLink
                                  to="/dashboard"
                                  exact
                                  className="nav__item-link nav-icon-orders "
                                >
                                  Orders
                                </NavLink>
                              </li>
                              <li className="nav__item">
                                <NavLink
                                  to="/dashboard/diesel"
                                  className="nav__item-link nav-icon-order_diesel"
                                >
                                  Request Diesel
                                </NavLink>
                              </li>
                              ...
                              <li className=" nav__item">
                                <NavLink
                                  to="/profile"
                                  className="nav__item-link nav-icon-account "
                                >
                                  Account Info
                                </NavLink>
                              </li>
                              ...
                              {isMobile && (
                                <li className="nav__item">
                                  ...
                                  >
                                    <i className="fa fa-power-off fs-18 mr-2" />
                                    Log Out
                                  </NavLink>
                                </li>
                              )}
