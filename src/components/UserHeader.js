...
import Auth from "../util/Auth.Model";
    ...
    render() {
        ...
        if (showNavSetting) {
            return (
                <div style={{zIndex: 99}} className="w-100 animated fadeIn mt--2 ">
                    <a href="javascript:void(0)" onClick={this.props.closeNavSetting}
        ...
        return (
            <div style={{zIndex: 99}} className="w-100 animated slideInUp mt--2 bg-white">
                ...
                <a href="javascript:void(0)" onClick={togglePostATask} className="profile-menu-item">
                    <span>Post Task</span>
                </a>
                ...
                {/*<a href="javascript:void(0)" onClick={this.props.openReferer}*/}
                {/*   className="mobile-click-item aligned w-100">*/}
                {/*    <span>Refer a Friend</span>*/}
                {/*</a>*/}


                <a href="javascript:void(0)" onClick={this.props.openNavSetting}
                   className="mobile-click-item aligned w-100">
                ...
                {/*</div>*/}
                <NavLink to={"/#"} onClick={Auth.logout} className="mobile-click-item">
                    <span>Logout</span>
                    <FaArrowRight class="mr-2 fs-12 text-black"/>
                </NavLink>
            </div>
...
class MobileBar extends Component<{}> {
    ...
    render() {
        const {showNavSetting, user} = this.props;
        if (showNavSetting) {
            return (
        ...
        return (
            <div className="mobile-button ff-500">
                ...
                <a href="javascript:void(0)" onClick={Auth.logout} className="mobile-nav-menu aligned w-100">
                    <span>Logout</span>
                    <FaArrowRight class="mr-2 fs-12 text-black"/>
                </a>
                    ...
                    <div className="header-container p-2 p-sm-0">
                        <div className="header-left-container-1">
                            <div className="header-left-container ">
                                <a className="mobile-button mobile-menu p-2" href="javascript:void(0)"
                                   style={{fontSize: 20}}
                                ...
                                <NavLink
                                    ...
                                    to="/account">
                                    <img src={logo} className="logo" alt="CitiTasker Logo"/>
                                </NavLink>
                        ...
                        <div className="header-right-container  web-button animated slideInRight">
                            <div className="ml-auto d-flex align-items-center">
                                ...
                                <NavLink className="auth-btn" to="/message/">Messages</NavLink>
                                <Dropdown
